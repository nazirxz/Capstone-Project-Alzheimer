...
public final class FragmentPatientProfileBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView bloodtypeTxt;
  ...
  private FragmentPatientProfileBinding(@NonNull NestedScrollView rootView,
      @NonNull TextView addressTxt, @NonNull TextView bloodtypeTxt, @NonNull Button btnEdit,
      @NonNull TextView dateTxt, @NonNull TextView emailTxt, @NonNull TextView fullnameTxt,
      @NonNull TextView genderTxt, @NonNull ImageView ivPicture, @NonNull Button logoutBtn,
      @NonNull TextView phoneTxt, @NonNull TextView tvAddress, @NonNull TextView tvBlood,
      @NonNull TextView tvDate, @NonNull TextView tvEmail, @NonNull TextView tvEmailProfile,
      @NonNull TextView tvFullname, @NonNull TextView tvGender, @NonNull TextView tvName,
      @NonNull TextView tvPhonenumber) {
    this.rootView = rootView;
    this.addressTxt = addressTxt;
    this.bloodtypeTxt = bloodtypeTxt;
  ...
  @NonNull
  public static FragmentPatientProfileBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPatientProfileBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_patient_profile, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPatientProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.bloodtype_txt;
      TextView bloodtypeTxt = ViewBindings.findChildViewById(rootView, id);
      if (bloodtypeTxt == null) {
        break missingId;
      }
      ...
      return new FragmentPatientProfileBinding((NestedScrollView) rootView, addressTxt,
          bloodtypeTxt, btnEdit, dateTxt, emailTxt, fullnameTxt, genderTxt, ivPicture, logoutBtn,
          phoneTxt, tvAddress, tvBlood, tvDate, tvEmail, tvEmailProfile, tvFullname, tvGender,
          tvName, tvPhonenumber);
    }
