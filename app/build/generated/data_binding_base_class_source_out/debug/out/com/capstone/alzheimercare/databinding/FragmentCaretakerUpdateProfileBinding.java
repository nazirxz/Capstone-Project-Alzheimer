...
public final class FragmentCaretakerUpdateProfileBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentCaretakerUpdateProfileBinding(@NonNull NestedScrollView rootView,
      @NonNull TextInputLayout addressTxt, @NonNull ImageView avatar, @NonNull ImageButton backBtn,
      @NonNull FloatingActionButton changePhoto, @NonNull CardView cvAvatar,
      @NonNull TextInputLayout dateBirthTxt, @NonNull TextInputLayout emailTxt,
      @NonNull TextInputLayout fullNameTxt, @NonNull TextInputLayout genderTxt,
      @NonNull TextInputEditText inputAddress, @NonNull TextInputEditText inputDateBirth,
  ...
  @NonNull
  public static FragmentCaretakerUpdateProfileBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentCaretakerUpdateProfileBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_caretaker_update_profile, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentCaretakerUpdateProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCaretakerUpdateProfileBinding((NestedScrollView) rootView, addressTxt,
          avatar, backBtn, changePhoto, cvAvatar, dateBirthTxt, emailTxt, fullNameTxt, genderTxt,
          inputAddress, inputDateBirth, inputEmail, inputFullName, inputGender, inputPhoneNumber,
          phoneNumberTxt, saveChangesBtn);
    }
